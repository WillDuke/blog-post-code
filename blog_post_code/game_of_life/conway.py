...
def create_random_grid(length: int = 10, width: int = 10, seed = None) -> np.array:
...
def count_neighbors_np(grid: np.array) -> np.array:
...
def convert_plaintext(text:str) -> np.array:
